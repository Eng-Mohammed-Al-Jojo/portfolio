        ...
        <ul className="hidden md:flex gap-4 text-sm font-semibold">
          {navItems.map((item) => (
            <li key={item.label}>
              <a
                href={item.href}
                className="px-3 py-2 rounded-lg transition-all duration-300 hover:bg-blue-600 hover:text-white dark:hover:bg-blue-500"
              >
                {item.label}
              </a>
            </li>
          ...
          {navItems.map((item) => (
            <li key={item.label}>
              <a
                href={item.href}
                onClick={closeMenu}
                className="block w-full px-3 py-2 rounded-lg transition-all duration-300 hover:bg-blue-600 hover:text-white dark:hover:bg-blue-500"
              >
                {item.label}
              </a>
            </li>
